...
class DataSynchronization:
    def __init__(self, psychopy_data_path, em_data_path):
...
if __name__ == "__main__":
    data_list = [file_name for file_name in os.listdir("./Data_Collection/FreeViewing/data") if file_name.endswith(".csv")]
    em_list = [file_name for file_name in os.listdir("./Data_Collection/FreeViewing/em") if file_name.endswith(".csv")]
    ...
    for psychopy_data_name, em_data_name in zip(sorted_data_list, sorted_em_list):
        ...
        ds = DataSynchronization(psychopy_data_path=psychopy_data_path, em_data_path=em_data_path)
        ds.run()
