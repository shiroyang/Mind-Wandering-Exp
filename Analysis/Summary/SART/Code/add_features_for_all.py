"""
This code will add temporal and spatial features for all window sizes range(4, 61, 4)
"""
...
def save_result():
    global result, input_dir, target_file
...
def main():
    ...
    for win_size in tqdm(range(4, 61, 4)):
        result = defaultdict((lambda: defaultdict(dict)))
        input_dir = f'./Preprocess/SART/Scanpath/{win_size}/'
